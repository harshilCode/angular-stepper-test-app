// features/stepper/components/steps/audience-workforce/audience-workforce.component.ts
...
@Component({
  selector: 'app-audience-workforce',
  standalone: true,
  imports: [ReactiveFormsModule],
  templateUrl: './audience-workforce.component.html'
})
export class AudienceWorkforceComponent {
  form!: FormGroup;
  appName = '';
